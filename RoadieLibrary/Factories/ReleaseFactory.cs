    ...
    public sealed class ReleaseFactory : FactoryBase
    {
        ...
        public async Task<OperationResult<bool>> ScanReleaseFolder(Guid releaseId, string destinationFolder, bool doJustInfo, Data.Release releaseToScan = null)
        {
            ...
            {                
                ...
                #endregion Get Tracks for Release from DB and remove any not found in Folder
                ...
                if (release.Thumbnail == null)
                {
                    ...
                    if (File.Exists(coverFileName))
                    {
                        ...
                        release.Thumbnail = ImageHelper.ResizeImage(release.Thumbnail, this.Configuration.GetValue<int>("Thumbnails:Width", 80), this.Configuration.GetValue<int>("Thumbnails:Height", 80));
            ...
            try
            {
                ...
                if (release == null || !release.IsValid)
                {
                    ...
                    if (doFindIfNotInDatabase)
                    {
                        ...
                        try
                        {
                            releaseSearch = await this.PerformMetaDataProvidersReleaseSearch(metaData, artist.ArtistFileFolder(this.Configuration, this.Configuration.GetValue<string>("LibraryFolder")), submissionId);
                        }
                        catch (Exception ex)
                        {
                            sw.Stop();
        ...
        public async Task<OperationResult<Data.Release>> PerformMetaDataProvidersReleaseSearch(AudioMetaData metaData, string artistFolder = null, int? submissionId = null)
        {
            ...
            var dontDoMetaDataProvidersSearchArtists = this.Configuration.GetValue<string[]>("DontDoMetaDataProvidersSearchArtists", new string[0]);
            ...
            if (releaseImageUrls.Any())
            {
                ...
                result.Images = existingImages.Where(x => x != null && x.Bytes != null).GroupBy(x => x.Signature).Select(x => x.First()).Take(this.Configuration.GetValue<int>("Processing.MaximumReleaseImagesToAdd", 12)).ToList();
        ...
        public async Task<FactoryResult<bool>> Delete(Data.Release release, bool doDeleteFiles = false)
        {
            ...
            if (doDeleteFiles)
            {
                ...
                foreach (var track in releaseTracks)
                {
                    ...
                    try
                    {
                        trackPath = track.PathToTrack(this.Configuration, this.Configuration.GetValue<string>("LibraryFolder"));
                        if (File.Exists(trackPath))
                        {
        ...
        public async Task<FactoryResult<Data.Release>> Update(Data.Release release, IEnumerable<Data.Image> releaseImages, string originalReleaseFolder, string destinationFolder = null)
        {
            ...
            var artistFolder = release.Artist.ArtistFileFolder(this.Configuration, destinationFolder ?? this.Configuration.GetValue<string>("LibraryFolder"));
        ...
        public async Task<FactoryResult<bool>> CheckAndChangeReleaseTitle(Data.Release release, string oldReleaseFolder, string destinationFolder = null)
        {
            ...
            destinationFolder = destinationFolder ?? this.Configuration.GetValue<string>("LibraryFolder");
        ...
        public async Task<FactoryResult<bool>> MergeReleases(Data.Release releaseToMerge, Data.Release releaseToMergeInto, bool addAsMedia)
        {
                    ...
                    else
                    {
                        ...
                        foreach (var mergeTrack in mergeTracks)
                        {
                            ...
                            else
                            {
                                ...
                                var mergedTrackFileName = mergeTrack.PathToTrack(this.Configuration, this.Configuration.GetValue<string>("LibraryFolder"));
                                var trackFileName = existingTrack.PathToTrack(this.Configuration, this.Configuration.GetValue<string>("LibraryFolder"));
            ...
            var destinationRoot = this.Configuration.GetValue<string>("LibraryFolder");
            ...
            if (mergedTracksToMove.Any())
            {
                ...
                {
                    var oldTrackPath = track.PathToTrack(this.Configuration, this.Configuration.GetValue<string>("LibraryFolder"));
