...
namespace Roadie.Library.Utility
{
    ...
    public static class FolderPathHelper
    {
        ...
        public static string ArtistPath(IConfiguration configuration, string artistSortName, string destinationFolder = null)
        {
        ...
        public static string TrackFileName(IConfiguration configuration, AudioMetaData metaData)
        {
        ...
        public static string TrackFileName(IConfiguration configuration, string trackTitle, short trackNumber, int? diskNumber = null, int? totalTrackNumber = null, string fileExtension = "mp3")
        {
            ...
            var trackPathReplace = configuration.GetValue<Dictionary<string, string>>("TrackPathReplace");
        ...
        public static string TrackPath(IConfiguration configuration, AudioMetaData metaData, string destinationFolder = null, string artistFolder = null)
        {
        ...
        /// <param name="destinationFolder">Optional Root folder defaults to Library Folder from Settings</param>
        /// <param name="artistFolder">Optional ArtistFolder default is to get from MetaData artist</param>
        public static string TrackFullPath(IConfiguration configuration, AudioMetaData metaData, string destinationFolder = null, string artistFolder = null)
        {
        ...
        /// <param name="totalTrackNumber">Optional Total Tracks defaults to TrackNumber</param>
        /// <param name="fileExtension">Optional File Extension defaults to mp3</param>
        public static string TrackPath(IConfiguration configuration, string artistSortName, string releaseTitle, DateTime releaseDate, string trackTitle, short trackNumber, string destinationFolder = null, int? diskNumber = null, int? totalTrackNumber = null, string fileExtension = "mp3")
        {
        ...
        /// <param name="totalTrackNumber">Optional Total Tracks defaults to TrackNumber</param>
        /// <param name="fileExtension">Optional File Extension defaults to mp3</param>
        public static string TrackFullPath(IConfiguration configuration, string artistSortName, string releaseTitle, DateTime releaseDate, string trackTitle, short trackNumber, string destinationFolder = null, int? diskNumber = null, int? totalTrackNumber = null, string fileExtension = "mp3", string artistFolder = null)
        {
            destinationFolder = destinationFolder ?? configuration.GetValue<string>("LibraryFolder");
        ...
        /// <param name="destinationFolder">Optional Root folder defaults to Library Folder from Settings</param>
        public static string PathForTrack(IConfiguration configuration, Data.Track track, string destinationFolder = null)
        {
            destinationFolder = destinationFolder ?? configuration.GetValue<string>("LibraryFolder");
        ...
        /// <param name="destinationFolder">Optional Root folder defaults to Library Folder from Settings</param>
        /// <returns></returns>
        public static bool DeleteEmptyFoldersForArtist(IConfiguration configuration, Data.Artist artist, string destinationFolder = null)
        {
            destinationFolder = destinationFolder ?? configuration.GetValue<string>("LibraryFolder");
